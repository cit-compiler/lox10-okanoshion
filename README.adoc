...
[source,console]
----
Exception in thread "main" java.lang.ClassCastException: class java.util.stream.ReferencePipeline$Head cannot be cast to class java.util.List (java.util.stream.ReferencePipeline$Head and java.util.List are in module java.base of loader 'bootstrap')
        at com.craftinginterpreters.lox.Lox.run(Lox.java:47)
        at com.craftinginterpreters.lox.Lox.runPrompt(Lox.java:40)
        at com.craftinginterpreters.lox.Lox.main(Lox.java:21)
----
